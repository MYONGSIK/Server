        ...
        for(int i=0; i<5; i++) {//일자별
            weekFoodResponses.add(
                WeekFoodResponse.builder()
                        ...
                        .dinner(Arrays.asList(dinners.get(i).getDinner1(),dinners.get(i).getDinner2(),dinners.get(i).getDinner3(),dinners.get(i).getDinner4(),dinners.get(i).getDinner5(),dinners.get(i).getDinner6()))
                        .build()
            );
        }
